...
class AboutItemTv extends StatefulWidget {
  final ResultTv model;

  const AboutItemTv({Key? key, required this.model}) : super(key: key);

  @override
  State<AboutItemTv> createState() => _AboutItemTvState();
}

class _AboutItemTvState extends State<AboutItemTv> {
